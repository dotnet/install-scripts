...
function distro_check()
{
    case $DISTRO_NAME in
        ...
        *"Fedora 32"* | *"Fedora 33"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-fedora.27-x64.rpm"
          ADDITIONAL_DEPS=("tar" "gzip" "compat-openssl10" "libicu")
          ;;
        *"Fedora 34"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-fedora.34-x64.rpm"
         ...
         *"Fedora Linux 35"* | "Fedora Linux 36"*)
          ...
          ADDITIONAL_DEPS=("tar" "gzip" "libicu")
          ;;
         *"Oracle Linux Server 9.1"* | "Oracle Linux Server 8.7"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-fedora.34-x64.rpm"
          ADDITIONAL_DEPS=("tar" "gzip" "libicu")
          ;;
        *"openSUSE"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-opensuse.42-x64.rpm"
          ADDITIONAL_DEPS=("tar" "gzip" "libopenssl1_0_0" "libicu")
          ;;
        *"sles"**)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-sles.12-x64.rpm"
          ADDITIONAL_DEPS=("tar" "gzip" "libopenssl1_0_0" "libicu")
          ;;
        *"CentOS"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-centos.7-x64.rpm"
          ADDITIONAL_DEPS=("tar" "gzip" "libicu")
          ;;
        *"CBL-Mariner"*)
          PACKAGE_TYPE="rpm"
          DEPS_PACKAGE="https://dotnetcli.blob.core.windows.net/dotnet/release/install-preview/8.0.0-preview.$PREVIEW_NUMBER/dotnet-runtime-deps-8.0.0-preview.$PREVIEW_NUMBER.$DEPS_BUILD-cm.1-x64.rpm"
          ADDITIONAL_DEPS=("icu")
          ;;
        *) SUPPORTED_DISTRO=0 ;;
    esac
...
function download_preview()
{
    case $PACKAGE_TYPE in
        "rpm")
            ...
            DOTNET_Spreview="dotnet-8.0.0-preview.$PREVIEW_NUMBER-rpm.tar.gz"
            ;;
        "deb")
            echo "*** Setting package type to deb."
            DOTNET_Spreview="dotnet-8.0.0-preview.$PREVIEW_NUMBER-deb.tar.gz"
            ;;
        *)
    esac

    echo "*** Download soupreviewe: ${DOTNET_Spreview}"
    echo
...
then
    ...
    echo "${DISTRO_NAME} is not supported by the .NET 8 Preview installer."
fi
