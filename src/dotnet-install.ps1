...
if (!$isAssetInstalled) {
    Say-Error "Failed to verify the version of installed `"$assetName`", installation source: $DownloadLink. Report the bug at https://github.com/dotnet/install-scripts/issues."
