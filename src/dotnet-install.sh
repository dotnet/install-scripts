...
install_dotnet() {
    ...
    say_err "Failed to verify the version of installed \`$asset_name\`, installation source: $download_link. Report the bug at https://github.com/dotnet/install-scripts/issues."
