...
namespace Microsoft.DotNet.InstallationScript.Tests
{
    public class GivenThatIWantToGetTheSdkLinksFromAScript : TestBase
    {
        ...
        [InlineData("6.0", "dotnet")]
        [InlineData("6.0", "dotnet", true)]
        [InlineData("7.0", "dotnet")]
        [InlineData("7.0", "dotnet", true)]
        [InlineData("8.0", "dotnet")]
        ...
        [InlineData("6.0", "aspnetcore")]
        [InlineData("6.0", "aspnetcore", true)]
        [InlineData("7.0", "aspnetcore")]
        [InlineData("7.0", "aspnetcore", true)]
        [InlineData("8.0", "aspnetcore")]
        ...
        [InlineData("6.0", "windowsdesktop")]
        [InlineData("6.0", "windowsdesktop", true)]
        [InlineData("7.0", "windowsdesktop")]
        [InlineData("7.0", "windowsdesktop", true)]
        [InlineData("8.0", "windowsdesktop")]
